...
class AdvertiseService(Advertisement):
...
def main():
    ...
    ad_adapter = find_ad_adapter(bus)
    if not ad_adapter:
    ...
    adapter_props = dbus.Interface(
        bus.get_object(BLUEZ_SERVICE_NAME, ad_adapter),
        "org.freedesktop.DBus.Properties")

    adapter_props.Set("org.bluez.Adapter1", "Powered", dbus.Boolean(1))

    print('setup ad_manager')
    ad_manager = dbus.Interface(bus.get_object(BLUEZ_SERVICE_NAME, ad_adapter),
    ...
    test_advertisement = AdvertiseService(bus, 0)
    ...
    print('Register Adver', test_advertisement.get_path())
    ad_manager.RegisterAdvertisement(test_advertisement.get_path(), {},
                                     reply_handler=register_ad_cb,
                                     error_handler=register_ad_error_cb)

    # print('Register Application', app.get_path())
    print('Battery service ', bat_service.get_path())
